...
public interface PayTableGraphRepository extends Neo4jBaseRepository<PayTable, Long> {
    ...
    void changeStateOfRelationShip(Long payTableId, LocalDate endDateMillis);
    ...
    List<PayTableResponse> findActivePayTablesByOrganizationLevel(Long organizationLevelId, LocalDate startDate);
