...
public interface OrganizationTypeGraphRepository extends Neo4jBaseRepository<OrganizationType, Long> {
    ...
    @Query("Match (n:Organization{isEnable:true,union:false,boardingCompleted:true,isKairosHub:false,gdprUnit:false,workCenterUnit:true})-[:"+SUB_TYPE_OF+"]->(organizationType:OrganizationType{isEnable:true}) where id(organizationType)={0} return DISTINCT n")
