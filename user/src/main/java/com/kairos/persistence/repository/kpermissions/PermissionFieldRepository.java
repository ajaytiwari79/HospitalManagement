...
public interface PermissionFieldRepository extends Neo4jBaseRepository<KPermissionField,Long> {
    ...
    List<List<String>> findPermissionFieldsByAccessGroupAndModelClass(String modelClass, List<Long> accessGroupIds, List<FieldLevelPermissions> permissions);
    ...
    List<KPermissionSubModelFieldQueryResult> findSubModelPermissionFieldsByAccessGroupAndModelClass(String modelClass, List<Long> accessGroupIds, List<FieldLevelPermissions> permissions);
