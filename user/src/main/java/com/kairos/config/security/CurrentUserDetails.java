...
public class CurrentUserDetails {
    ...
    public CurrentUserDetails(Long id, String userName, String nickName,
                              ...
                              String googleCalenderTokenId,String googleCalenderAccessToken) {
        this.id = id;
        ...
        this.googleCalenderTokenId = googleCalenderTokenId;
        this.googleCalenderAccessToken = googleCalenderAccessToken;
    }
}
