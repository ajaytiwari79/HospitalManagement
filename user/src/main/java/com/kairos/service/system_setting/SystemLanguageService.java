...
public class SystemLanguageService {
    ...
    public List<SystemLanguageDTO> getListOfSystemLanguage() {
        return ObjectMapperUtils.copyPropertiesOrCloneCollectionByMapper(systemLanguageGraphRepository.getListOfSystemLanguage(), SystemLanguageDTO.class);
    ...
    public List<SystemLanguageDTO> getSystemLanguageOfCountry(Long countryId) {
        ...
        return ObjectMapperUtils.copyPropertiesOrCloneCollectionByMapper(systemLanguageGraphRepository.findSystemLanguagesByCountryId(countryId), SystemLanguageDTO.class);
    }
    ...
    public List<SystemLanguageDTO> getSystemLanguageAndCountryMapping(Long countryId) {
        ...
        List<SystemLanguageDTO> systemLanguageDTOS = ObjectMapperUtils.copyPropertiesOrCloneCollectionByMapper(systemLanguageGraphRepository.getActiveSystemLanguages(), SystemLanguageDTO.class);
