...
public class ActivityIntegrationService {
    ...
    public void updateTimeBank(Long unitPositionId, LocalDate shiftStartDate, StaffAdditionalInfoDTO staffAdditionalInfoDTO){
        ...
        param.add(startDate);
        genericRestClient.publishRequest(staffAdditionalInfoDTO,staffAdditionalInfoDTO.getUnitId(),true,IntegrationOperation.UPDATE,"/update_time_bank",param,new ParameterizedTypeReference<RestTemplateResponseEnvelope<Boolean>>(){});
