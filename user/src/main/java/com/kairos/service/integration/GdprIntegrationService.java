...
public class GdprIntegrationService {
    ...
    public boolean createDefaultDataForOrganization(long countryId, long unitId) {
        ...
        return true;
        //genericRestClient.publishRequest(organizationTypeSubType, unitId, true, IntegrationOperation.CREATE, "/inherit", null, new ParameterizedTypeReference<RestTemplateResponseEnvelope<Boolean>>() {}
