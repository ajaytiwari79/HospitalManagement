...
public class GdprIntegrationService {
    ...
    public boolean createDefaultDataForOrganization(Long countryId, Long unitId) {
        ...
        return genericRestClient.publish(organizationTypeAndSubTypeIdDTO, unitId, true, IntegrationOperation.CREATE, "/inherit", null, new ParameterizedTypeReference<RestTemplateResponseEnvelope<Boolean>>() {
        });
    }
