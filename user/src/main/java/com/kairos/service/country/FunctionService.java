...
public class FunctionService {
    ...
    public Map<LocalDate, List<FunctionDTO>> findAppliedFunctionsAtEmployment(Long unitId, String startDate, String endDate) {
        List<EmploymentQueryResult> employmentQueryResults = ObjectMapperUtils.copyPropertiesOrCloneCollectionByMapper(functionGraphRepository.findAppliedFunctionsAtEmpployment(unitId, startDate, endDate), EmploymentQueryResult.class);
