...
public class StaffRetrievalService {
    ...
    public Map<String, Object> getPersonalInfo(long staffId, long unitId) {
        ...
        Staff staff = staffGraphRepository.findById(staffId).orElseThrow(() -> new DataNotFoundByIdException(exceptionService.convertMessage(MESSAGE_STAFF_IDANDUNITID_NOTFOUND, staffId, unitId)));
    ...
    private Map<String, Object> retrievePersonalInfo(Staff staff, Long unitId) {
        ...
        map.put("staffChildDetails", ObjectMapperUtils.copyPropertiesOfListByMapper(staff.getStaffChildDetails(), StaffChildDetailDTO.class));
        return map;
    }
    ...
    private StaffAdditionalInfoDTO getStaffEmploymentData(LocalDate shiftDate, StaffAdditionalInfoQueryResult staffAdditionalInfoQueryResult, Long employmentId, long organizationId, Set<Long> reasonCodeIds) {
        ...
        if (Optional.ofNullable(employment).isPresent()) {
            ...
            staffAdditionalInfoDTO.setStaffChildDetailDTOS(ObjectMapperUtils.copyPropertiesOfListByMapper(staffAdditionalInfoQueryResult.getStaffChildDetails(), StaffChildDetailDTO.class));
        }
