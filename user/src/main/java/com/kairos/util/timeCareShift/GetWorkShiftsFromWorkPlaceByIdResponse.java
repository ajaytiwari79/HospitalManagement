...
public class GetWorkShiftsFromWorkPlaceByIdResponse {
    ...
    //    public GetWorkShiftsFromWorkPlaceByIdResponse(com.kairos.user.domain.util.timeCareShift.GetWorkShiftsFromWorkPlaceByIdResult[] getWorkShiftsFromWorkPlaceByIdResult) {
