...
import com.kairos.repositories.CustomTimeScaleRepository;
...
import com.kairos.rule_validator.task.TaskSpecification;
...
import com.kairos.services.restrcition_freuency.RestrictionFrequencyService;
...
import static com.kairos.constants.ClientExceptionConstant.SICK;
...
public class TaskExceptionService extends MongoBaseService {
    ...
    public List<TaskGanttDTO> confirmAppointmentSuggestion(long unitId,long taskId, @RequestBody Map<String, Object> payload) throws ParseException {
        ...
        confirmMetaData.put(EXT_ID,task.getId());
        ...
        callInfoMetaData.put(EXT_ID,task.getId());
    ...
    */
    ...
    public List<TaskGanttDTO> copySingleTask(BigInteger taskId, List<Map<String, Object>> taskData) throws ParseException {
        ...
        if (!task.isSingleTask()) {
            exceptionService.internalError("");
        }
    ...
    public void saveSettingsOfPlanner(long unitId, Map<String, Object> plannerSettings) {
        ...
        if (plannerSettings.get(CITIZEN_ID) instanceof Integer) {
            citizenId = (int) plannerSettings.get(CITIZEN_ID);
        } else {
            citizenId = (long) plannerSettings.get(CITIZEN_ID);
        }
