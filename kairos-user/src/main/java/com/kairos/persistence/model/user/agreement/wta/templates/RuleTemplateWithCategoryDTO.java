...
public class RuleTemplateWithCategoryDTO {
    ...
    private Map ruleTemplateCategory;
    private  Long ruleTemplateCategoryId;
    ...
    public Map getRuleTemplateCategory() {
    ...
    public void setRuleTemplateCategoryId(Long ruleTemplateCategoryId) {
