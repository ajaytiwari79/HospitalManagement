...
public class CountryController {
    ...
    ResponseEntity<Map<String, Object>> createCountry(@Validated @RequestBody Country country) {
        if (country != null) {
    ...
    @ApiOperation("Create a new Country")
    ResponseEntity<Map<String, Object>> updateCountry(@Validated @RequestBody Country country) {
        if (country != null) {
    ...
    ResponseEntity<Map<String, Object>> getAllCountry(@PathVariable Long organizationId) {
    ...
    ResponseEntity<Map<String, Object>> deleteCountry(@PathVariable Long countryId) {
        if (countryId != null) {
    ...
    ResponseEntity<Map<String, Object>> getOrgTypesByCountryId(@PathVariable Long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addOrgTypesByCountryId(@PathVariable Long countryId, @Validated @RequestBody OrganizationType data) {
    ...
    ResponseEntity<Map<String, Object>> updateOrganizationType(@Validated @RequestBody OrganizationType data) {
    ...
    ResponseEntity<Map<String, Object>> deleteOrganizationSubTypeById(@PathVariable Long organizationTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getOrgTypesSubByCountryId(@PathVariable Long countryId, @PathVariable long organizationTypeId) {
    ...
    ResponseEntity<Map<String, Object>> addOrgTypesSubByCountryId(@PathVariable Long countryId, @Validated @RequestBody OrganizationType data, @PathVariable long organizationTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getAllSkillCategory(@PathVariable Long countryId) {
        if (countryId != null) {
    ...
    ResponseEntity<Map<String, Object>> addSkillCategory(@PathVariable long countryId, @Validated @RequestBody SkillCategory objectToSave) {
    ...
    ResponseEntity<Map<String, Object>> updateSkillCategoryById(@RequestBody @Validated SkillCategory skillData, @PathVariable Long countryId) {
    ...
    ResponseEntity<Map<String, Object>> getSkillsByCategoryId(@PathVariable Long categoryId) {
        if (categoryId != null) {
    ...
    ResponseEntity<Map<String, Object>> addSkill(@PathVariable long skillCategoryId, @RequestBody Skill skill) {
    ...
    ResponseEntity<Map<String, Object>> updateSkillById(@PathVariable long countryId, @RequestBody Skill skill) {
    ...
    ResponseEntity<Map<String, Object>> deleteSkill(@PathVariable long skillId) {
    ...
    ResponseEntity<Map<String, Object>> createParentOrganization(@PathVariable long countryId, @RequestBody ParentOrganizationDTO organization) {
    ...
    ResponseEntity<Map<String, Object>> updateParentOrganization(@PathVariable long countryId, @PathVariable long parentOrganizationId, @RequestBody ParentOrganizationDTO organization) {
        if (organization == null) {
            return ResponseHandler.generateResponse(HttpStatus.BAD_REQUEST, false, null);
        }
        return ResponseHandler.generateResponse(HttpStatus.OK, true, organizationService.updateParentOrganization(organization, parentOrganizationId));
    }
    ...
    ResponseEntity<Map<String, Object>> deleteParentOrganization(@PathVariable long parentOrganizationId) {
    ...
    ResponseEntity<Map<String, Object>> getDayType(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addDayType(@PathVariable long countryId, @Validated @RequestBody DayType dayType) {
    ...
    ResponseEntity<Map<String, Object>> updateDayType(@Validated @RequestBody DayType dayType) {
    ...
    ResponseEntity<Map<String, Object>> deleteDayType(@PathVariable long dayTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getClinicType(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addClinicType(@PathVariable long countryId, @Validated @RequestBody ClinicType clinicType) {
    ...
    ResponseEntity<Map<String, Object>> updateClinicType(@Validated @RequestBody ClinicType clinicType) {
    ...
    ResponseEntity<Map<String, Object>> deleteClinicType(@PathVariable long clinicTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getIndustryType(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addIndustryType(@PathVariable long countryId, @Validated @RequestBody IndustryType industryType) {
    ...
    ResponseEntity<Map<String, Object>> updateIndustryType(@Validated @RequestBody IndustryType industryType) {
    ...
    ResponseEntity<Map<String, Object>> deleteIndustryType(@PathVariable long industryTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getOwnershipType(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addOwnershipType(@PathVariable long countryId, @Validated @RequestBody OwnershipType ownershipType) {
    ...
    ResponseEntity<Map<String, Object>> updateOwnershipType(@Validated @RequestBody OwnershipType ownershipType) {
    ...
    ResponseEntity<Map<String, Object>> deleteOwnershipType(@PathVariable long ownershipTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getBusinessType(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addBusinessType(@PathVariable long countryId, @Validated @RequestBody BusinessType businessType) {
    ...
    ResponseEntity<Map<String, Object>> updateBusinessType(@Validated @RequestBody BusinessType businessType) {
    ...
    ResponseEntity<Map<String, Object>> deleteBusinessType(@PathVariable long businessTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getContractType(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addContractType(@PathVariable long countryId, @Validated @RequestBody ContractType contractType) {
    ...
    ResponseEntity<Map<String, Object>> updateContractType(@Validated @RequestBody ContractType contractType) {
    ...
    ResponseEntity<Map<String, Object>> deleteContractType(@PathVariable long contractTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getVatType(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addVatType(@PathVariable long countryId, @Validated @RequestBody VatType vatType) {
    ...
    ResponseEntity<Map<String, Object>> updateVatType(@Validated @RequestBody VatType vatType) {
    ...
    ResponseEntity<Map<String, Object>> deleteVatType(@PathVariable long vatTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getEmployeeLimit(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addEmployeeLimit(@PathVariable long countryId, @Validated @RequestBody EmployeeLimit employeeLimit) {
    ...
    ResponseEntity<Map<String, Object>> updateEmployeeLimit(@Validated @RequestBody EmployeeLimit employeeLimit) {
    ...
    ResponseEntity<Map<String, Object>> addPaymentType(@PathVariable long countryId, @RequestBody PaymentType objectToSave) {
    ...
    @ApiOperation("create payment type")
    ResponseEntity<Map<String, Object>> getPaymentTypes(@PathVariable long countryId) {
    ...
    @ApiOperation("create payment type")
    ResponseEntity<Map<String, Object>> updatePaymentType(@RequestBody PaymentType paymentType) {
    ...
    @ApiOperation("create payment type")
    ResponseEntity<Map<String, Object>> deletePaymentType(@PathVariable long paymentTypeId) {
    ...
    ResponseEntity<Map<String, Object>> addCurrency(@PathVariable long countryId, @RequestBody @Validated Currency objectToSave) {
    ...
    ResponseEntity<Map<String, Object>> getCurrencies(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> updateCurrency(@RequestBody @Validated Currency currency) {
    ...
    ResponseEntity<Map<String, Object>> deleteCurrency(@PathVariable long currencyId) {
    ...
    ResponseEntity<Map<String, Object>> getKairosStatus(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addKairosStatus(@PathVariable long countryId, @Validated @RequestBody KairosStatus kairosStatus) {
    ...
    ResponseEntity<Map<String, Object>> updateKairosStatus(@Validated @RequestBody KairosStatus kairosStatus) {
    ...
    ResponseEntity<Map<String, Object>> deleteKairosStatus(@PathVariable long kairosStatusId) {
    ...
    ResponseEntity<Map<String, Object>> getHousingType(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addHousingType(@PathVariable long countryId, @Validated @RequestBody HousingType housingType) {
    ...
    ResponseEntity<Map<String, Object>> updateHousingType(@Validated @RequestBody HousingType housingType) {
    ...
    ResponseEntity<Map<String, Object>> deleteHousingType(@PathVariable long housingTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getLocationType(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addLocationType(@PathVariable long countryId, @Validated @RequestBody LocationType locationType) {
    ...
    ResponseEntity<Map<String, Object>> updateLocationType(@Validated @RequestBody LocationType locationType) {
    ...
    ResponseEntity<Map<String, Object>> deleteLocationType(@PathVariable long locationTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getEngineerType(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addEngineerType(@PathVariable long countryId, @Validated @RequestBody EngineerType engineerType) {
    ...
    ResponseEntity<Map<String, Object>> updateEngineerTypee(@Validated @RequestBody EngineerType engineerType) {
    ...
    ResponseEntity<Map<String, Object>> deleteEngineerType(@PathVariable long engineerTypeId) {
    ...
    ResponseEntity<Map<String, Object>> getLanguage(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addLanguage(@PathVariable long countryId, @Validated @RequestBody Language language) {
    ...
    ResponseEntity<Map<String, Object>> updateLanguage(@Validated @RequestBody Language language, @PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> deleteLanguage(@PathVariable long languageId) {
    ...
    ResponseEntity<Map<String, Object>> getLanguageLevel(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addLanguageLevel(@PathVariable long countryId, @Validated @RequestBody LanguageLevel language) {
    ...
    ResponseEntity<Map<String, Object>> updateLanguageLevel(@Validated @RequestBody LanguageLevel language, @PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> deleteLanguageLevel(@PathVariable long languageLevelId) {
    ...
    ResponseEntity<Map<String, Object>> getCitizenStatus(@PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> addCitizenStatus(@PathVariable long countryId, @Validated @RequestBody CitizenStatus citizenStatus) {
    ...
    ResponseEntity<Map<String, Object>> updateCitizenStatus(@Validated @RequestBody CitizenStatus citizenStatus, @PathVariable long countryId) {
    ...
    ResponseEntity<Map<String, Object>> deleteCitizenStatus(@PathVariable long citizenStatusId) {
    ...
    ResponseEntity<Map<String, Object>> addSkillInExpertise(@PathVariable long expertiseId, @RequestBody ExpertiseSkillDTO expertiseSkillDTO) {
    ...
    ResponseEntity<Map<String, Object>> addSkillInExpertise(@PathVariable long countryId, @PathVariable long expertiseId) {
