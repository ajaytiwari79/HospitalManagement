...
public class TeamController {
    ...
    ResponseEntity<Map<String, Object>> createTeam(@PathVariable long groupId, @PathVariable Long unitId, @Validated @RequestBody TeamDTO teamDTO, @RequestParam("type") String type) {
...
*/
    ...
    ResponseEntity<Map<String, Object>> getTeams(@PathVariable long groupId) {
    ...
    ResponseEntity<Map<String, Object>> getTeamAvailableSkills(@PathVariable Long teamId) {
    ...
    ResponseEntity<Map<String, Object>> getTeamSelectedSkills(@PathVariable Long teamId) {
    ...
    ResponseEntity<Map<String, Object>> addTeamSkills(@PathVariable Long teamId, @RequestBody Map<String, Long[]> data) {
    ...
    ResponseEntity<Map<String, Object>> getTeamAvailableService(@PathVariable Long teamId) {
    ...
    ResponseEntity<Map<String, Object>> getTeamSelectedService(@PathVariable Long teamId) {
    ...
    ResponseEntity<Map<String, Object>> addTeamService(@PathVariable Long teamId, @RequestBody Map<String, Long[]> data) {
    ...
    ResponseEntity<Map<String, Object>> addStaffInTeam(@PathVariable long unitId,@PathVariable long teamId, @RequestBody Map<String, Object> staffInfo, @RequestParam("type") String type) {
    ...
    ResponseEntity<Map<String, Object>> getStaffOfUnit(@PathVariable long teamId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getStaffOfTeam(@PathVariable Long teamID) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getUserStaffType(@PathVariable Long userId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
   ...
   /* @ApiOperation(value = "Get Available TaskTypes")
    ...
    ResponseEntity<Map<String, Object>> getOrganizationAvailableTaskType(@PathVariable Long teamId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
