...
public class OrganizationController {
    ...
    ResponseEntity<Map<String, Object>> addOrganization(@Validated @RequestBody OrganizationDTO organizationDTO, @PathVariable long unitId) {
    ...
    ResponseEntity<Map<String, Object>> getOrganization(@PathVariable long unitId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getManageHierarchyData(@PathVariable long unitId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getOrganizationAvailableSkills(@PathVariable long unitId, @RequestParam("type") String type) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getUnitData(@PathVariable long unitId, @RequestParam("type") String type) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> addOrganizationSkills(@PathVariable long unitId, @RequestBody Map<String, Object> data, @RequestParam("type") String type) {

        long skillId = Long.valueOf(String.valueOf(data.get("skillId")));
        boolean isSelected = (boolean) data.get("isSelected");
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
                skillService.addNewSkill(unitId, skillId, isSelected, type));
    }
    ...
    ResponseEntity<Map<String, Object>> updateVisitourIdOfSkill(@PathVariable long unitId, @PathVariable long skillId, @RequestBody Map<String, Object> data) {

        if (data.get("visitourId") != null && data.get("visitourId") != "") {
            return ResponseHandler.generateResponse(HttpStatus.OK, true, skillService.updateVisitourIdOfSkill(unitId, skillId, (String) data.get("visitourId")));
        }
    ...
    ResponseEntity<Map<String, Object>> getStaffSkills(@PathVariable long unitId) {
    ...
    ResponseEntity<Map<String, Object>> assignSkillToStaff(@PathVariable long skillId, @PathVariable long unitId, @RequestBody Map<String, Object> data) {


        long staffId = Long.valueOf((String) data.get("staffId"));
        boolean isSelected = (boolean) data.get("isSelected");
        return ResponseHandler.generateResponse(HttpStatus.OK, true, skillService.assignSkillToStaff(unitId, staffId, skillId, isSelected));
    }
    ...
    ResponseEntity<Map<String, Object>> getOrganizationServiceData(@PathVariable long organizationId, @PathVariable long unitId, @RequestParam("type") String type) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> addOrganizationService(@PathVariable long unitId, @RequestBody Map<String, Object> data, @RequestParam("type") String type) {
...
/* anil m2 move this endpoints in task type controller
    ...
    ResponseEntity<Map<String, Object>> getTaskTypes(@PathVariable long subServiceId, @PathVariable long unitId, @RequestParam("type") String type) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> addTaskTypeInOrganization(@PathVariable long organizationId, @PathVariable long unitId, @PathVariable long subServiceId,
    ...
    ResponseEntity<Map<String, Object>> getTimeSlots(@PathVariable long unitId) {
    ...
    ResponseEntity<Map<String, Object>> createTimeSlot(@PathVariable long unitId, @Validated @RequestBody TimeSlotDTO timeSlotDTO) {
    ...
    ResponseEntity<Map<String, Object>> updateTimeSlotType(@PathVariable long unitId, @RequestBody Map<String, Object> timeSlotType) {
    ...
    ResponseEntity<Map<String, Object>> updateTimeSlot(@PathVariable long unitId, @Validated @RequestBody List<TimeSlotDTO> timeSlotDTO) {
    ...
    ResponseEntity<Map<String, Object>> deleteTimeSlot(@PathVariable long unitId, @PathVariable long timeSlotId) {
    ...
    ResponseEntity<Map<String, Object>> getOrganizationHierarchy(@PathVariable Long organizationId) {
    ...
    ResponseEntity<Map<String, Object>> getOrganizationHierarchyForOrganizationTab(@PathVariable long organizationId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getOrganizationClients(@PathVariable Long organizationId, @PathVariable Long unitId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getOrganizationClientsWithPlanning(@PathVariable Long organizationId, @PathVariable Long unitId, @RequestHeader(value = "authToken") String authToken) {

        return ResponseHandler.generateResponse(HttpStatus.OK, true,
                clientService.getOrganizationClientsWithPlanning(unitId, authToken));
    }
    ...
    ResponseEntity<Map<String, Object>> getOrganizationAllClients(@PathVariable long organizationId, @PathVariable long unitId) {
    ...
    ResponseEntity<Map<String, Object>> batchCreateClient(@PathVariable long unitId, @RequestParam("file") MultipartFile multipartFile) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getStaffByOrganizationId(@PathVariable Long organizationId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getGeneralDetails(@PathVariable long unitId, @RequestParam("type") String type) {
    ...
    @ApiOperation("Get general details of Client")
    ResponseEntity<Map<String, Object>> updateOrganizationGeneralDetails(@PathVariable long unitId, @Validated @RequestBody OrganizationGeneral organizationGeneral) throws ParseException {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> updateGroupGeneralDetails(@PathVariable long unitId, @Validated @RequestBody Group group) throws ParseException {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> updateTeamGeneralDetails(@PathVariable long unitId, @Validated @RequestBody TeamDTO teamDTO) throws ParseException {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getUnitTeams(@PathVariable Long unitId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getLanguages(@PathVariable long unitId) {
    ...
    @ApiOperation("Update Opening hour details")
    ResponseEntity<Map<String, Object>> updateOpeningHoursDetails(@RequestBody OpeningHours openingHours) {
    ...
    ResponseEntity<Map<String, Object>> getOpeningHoursDetails(@PathVariable Long unitId) {
    ...
    @ApiOperation("Get Unit opening hours")
    ResponseEntity<Map<String, Object>> getHolidays(@PathVariable long unitId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> updateParentOrganization(@PathVariable Long countryId, @PathVariable long organizationId, @RequestBody ParentOrganizationDTO data) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getParentOrganization(@PathVariable long countryId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getChildUnits(@PathVariable long organizationId, @RequestParam(value = "moduleId") String moduleId,
    ...
    ResponseEntity<Map<String, Object>> getOrganizationResources(@PathVariable Long unitId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getOrganizationResourcesTypes() {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> updateOrganizationResources(@PathVariable Long unitId, @RequestBody Resource resource) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> createUnitManager(@PathVariable long unitId, @Validated @RequestBody UnitManagerDTO unitManagerDTO) {
    ...
    ResponseEntity<Map<String, Object>> getUnitManager(@PathVariable long organizationId, @PathVariable long unitId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> getAddress(@PathVariable long unitId, @RequestParam("type") String type) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    @ApiOperation("get location of organization")
    ResponseEntity<Map<String, Object>> getAddressByZipCode(@PathVariable long zipCodeId) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> updateContactAddress(@PathVariable long unitId, @Validated @RequestBody AddressDTO address, @RequestParam("type") String type) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> updateBillingAddress(@PathVariable long unitId, @RequestBody AddressDTO addressDetails) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> saveBillingAddress(@PathVariable long unitId, @RequestBody AddressDTO addressDetails) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    @ApiOperation("Update Team of a Unit")
    ResponseEntity<Map<String, Object>> addUnitAddress(@PathVariable Long unitId, @RequestBody Map<String, Object> contactAddress) {
        return ResponseHandler.generateResponse(HttpStatus.OK, true,
    ...
    ResponseEntity<Map<String, Object>> deleteOrganizationById(@PathVariable Long organizationId, @PathVariable Long unitId) {
    ...
    ResponseEntity<Map<String, Object>> requestForCreateNewSkill(@PathVariable long unitId, @RequestBody Skill skill) {
    ...
    ResponseEntity<Map<String, Object>> getIntegrationServices() {
    ...
    ResponseEntity<Map<String, Object>> addIntegrationService(@Validated @RequestBody IntegrationConfiguration objectToSave) {
    ...
    ResponseEntity<Map<String, Object>> updateIntegrationService(@Validated @RequestBody IntegrationConfiguration integrationConfiguration, @PathVariable long integrationServiceId) {
    ...
    ResponseEntity<Map<String, Object>> deleteIntegrationService(@PathVariable long integrationServiceId) {
    ...
    ResponseEntity<Map<String, Object>> updateOrganizationExternalId(@PathVariable long organizationId, @PathVariable long externalId) {
    ...
    ResponseEntity<Map<String, Object>> updateOrganizationEstimoteCredentials(@PathVariable(value = "unitId") long unitId, @RequestBody Map<String, String> payload) {
    ...
    ResponseEntity<Map<String, Object>> getOrganizationEstimoteCredentials(@PathVariable(value = "unitId") long unitId) {
    ...
    ResponseEntity<Map<String, Object>> createLinkParentWithChildOrganization(@PathVariable(value = "unitId") long unitId, @PathVariable(value = "childId") long childId) {
    ...
    ResponseEntity<Map<String, Object>> assignStaffToCitizen(@RequestBody ClientStaffDTO clientStaffDTO) {
    ...
    ResponseEntity<Map<String, Object>> assignMultipleStaffToClient(@PathVariable long unitId, @RequestBody ClientStaffDTO clientStaffDTO) {
    ...
    ResponseEntity<Map<String, Object>> getAssignedStaffOfCitizen(@PathVariable long unitId) {
