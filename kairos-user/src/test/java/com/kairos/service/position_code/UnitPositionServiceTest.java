...
public class UnitPositionServiceTest {
    ...
    public void validateUnitEmploymentPositionWithExpertiseWithoutEndDate() throws Exception {
        ...
        when(unitEmploymentPositionService.validateUnitEmploymentPositionWithExpertise(unitPositions, unitEmploymentPositionDTO))
    ...
    public void validateUnitEmploymentPositionWithExpertiseWithEndDates() throws Exception {
        ...
        System.out.println(unitEmploymentPositionService.validateUnitEmploymentPositionWithExpertise(unitPositions, unitEmploymentPositionDTO));
    }
...
*/
    ...
    public void validateUnitEmploymentPositionWithExpertiseWithEndDate() throws Exception {
        ...
        unitEmploymentPositionService.validateUnitEmploymentPositionWithExpertise(unitPositions, unitEmploymentPositionDTO);
