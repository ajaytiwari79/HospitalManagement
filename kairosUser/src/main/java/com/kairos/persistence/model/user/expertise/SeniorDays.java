 ...
 */
@NodeEntity
public class SeniorDays extends UserBaseEntity implements Comparable<SeniorDays>{
    private int from;
    private int to;
    ...
    public SeniorDays(int from, int to, int leavesAllowed) {
        this.from = from;
        this.to = to;
    ...
    @Override
    public int compareTo(SeniorDays o) {
