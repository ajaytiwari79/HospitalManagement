...
NAME("Name"),DESCRIPTION("Description"),MANAGING_DEPARTMENT("Managing Department"), PROCESS_OWNER("Process Owner"),PROCESSING_PURPOSES("Processing Purpose"),DATA_SOURCES("Data Source"),
    TRANSFERMETHODS("Transfer method"),ACCESSOR_PARTY("Accessor Parties"),PROCESSING_LEGAL_BASIS("Processing Legal Basis"),RESPONSIBILITY_TYPE("Responsibility Type"),CONTROLLER_CONTACT_INFO("Controller Contact Info")
