...
public class AssetTypeMongoRepositoryImpl implements CustomAssetTypeRepository {
    ...
    final String addNonDeletedSubAsset = CustomAggregationQuery.assetTypesAddNonDeletedSubAssetTypes();
    Document addNonDeletedSubAssetOperation = Document.parse(addNonDeletedSubAsset);
    ...
    public List<AssetTypeResponseDto> getAllAssetTypesWithSubAssetTypes(Long countryId, Long organizationId) {
        ...
        Aggregation aggregation = Aggregation.newAggregation(
                ...
                new CustomAggregationOperation(addNonDeletedSubAssetOperation)
        );
