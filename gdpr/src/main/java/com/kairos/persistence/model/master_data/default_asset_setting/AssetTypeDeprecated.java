...
public class AssetTypeDeprecated {
    ...
    public AssetTypeDeprecated(String name, Long countryId, SuggestedDataStatus suggestedDataStatus) {
        this.name = name;
    ...
    public AssetTypeDeprecated(String name) {
        this.name = name;
    }
