...
@Entity
public class TechnicalSecurityMeasureMD extends BaseEntity {
    ...
    public TechnicalSecurityMeasureMD(String name) {
        this.name = name;
    }

    public TechnicalSecurityMeasureMD(@NotBlank(message = "Name can't be empty")String name, Long countryId, SuggestedDataStatus suggestedDataStatus) {
        this.name = name;
        this.countryId = countryId;
