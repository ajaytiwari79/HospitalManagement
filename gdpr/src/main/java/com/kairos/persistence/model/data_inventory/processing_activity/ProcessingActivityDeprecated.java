...
public class ProcessingActivityDeprecated {
    ...
    public ProcessingActivityDeprecated() {
    }

    public ProcessingActivityDeprecated(String name, String description, ManagingOrganization managingDepartment, Staff processOwner) {
        this.name = name;
    ...
    public ProcessingActivityDeprecated(String name, String description, boolean active) {
        this.name = name;
        this.description = description;
        this.active = active;
    }
