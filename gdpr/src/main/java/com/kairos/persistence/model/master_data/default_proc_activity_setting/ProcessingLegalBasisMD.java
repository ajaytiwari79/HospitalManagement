...
@Entity
public class ProcessingLegalBasisMD extends BaseEntity {
    ...
    public ProcessingLegalBasisMD(@NotBlank(message = "error.message.name.cannot.be.null.or.empty")String name, Long countryId, SuggestedDataStatus suggestedDataStatus) {
        this.name = name;
        this.countryId = countryId;
