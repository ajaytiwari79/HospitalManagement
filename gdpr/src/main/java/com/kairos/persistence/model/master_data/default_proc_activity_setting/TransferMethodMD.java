...
@Entity
public class TransferMethodMD extends BaseEntity {
    ...
    public TransferMethodMD(@NotBlank(message = "Name can't be empty")  String name, Long countryId, SuggestedDataStatus suggestedDataStatus) {
        this.name = name;
        this.countryId = countryId;
