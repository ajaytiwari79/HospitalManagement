...
class ResponsibilityTypeDeprecated {
    ...
    public ResponsibilityTypeDeprecated(@NotBlank(message = "error.message.name.cannot.be.null.or.empty")  String name, Long countryId, SuggestedDataStatus suggestedDataStatus) {
        this.name = name;
        this.countryId = countryId;
        this.suggestedDataStatus = suggestedDataStatus;
    }

    public ResponsibilityTypeDeprecated(String name) {
        this.name = name;
    }
    public ResponsibilityTypeDeprecated() {
    }
}
