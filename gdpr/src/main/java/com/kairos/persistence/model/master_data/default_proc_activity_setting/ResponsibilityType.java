...
public class ResponsibilityType extends BaseEntity {
    ...
    public ResponsibilityType(@NotBlank(message = "error.message.name.cannot.be.null.or.empty") @Pattern(message = "Numbers and Special characters are not allowed for Name", regexp = "^[a-zA-Z\\s]+$") String name, Long countryId) {
        this.name = name;
        this.countryId = countryId;
    }
