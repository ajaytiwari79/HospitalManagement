...
@Entity
public class HostingTypeMD extends BaseEntity {
    ...
    public HostingTypeMD(@NotBlank(message = "Name can't be empty") String name, Long countryId, SuggestedDataStatus suggestedDataStatus) {
        this.name = name;
        this.countryId = countryId;
    ...
    public HostingTypeMD(String name) {
        this.name = name;
    }
}
