...
@Entity
public class AccessorPartyMD extends BaseEntity {
    ...
    public AccessorPartyMD(String name) {
        this.name = name;
    }

    public AccessorPartyMD(@NotBlank(message = "error.message.name.cannot.be.null.or.empty") String name, Long countryId, SuggestedDataStatus suggestedDataStatus) {
        this.name = name;
        this.countryId = countryId;
