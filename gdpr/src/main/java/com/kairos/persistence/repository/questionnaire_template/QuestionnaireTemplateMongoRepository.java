...
public interface QuestionnaireTemplateMongoRepository extends MongoBaseRepository<QuestionnaireTemplate, BigInteger>, CustomQuestionnaireTemplateRepository {
    ...
    @Query("{organizationId:?0,templateType:?1,riskAssociatedEntity:?2,deleted:false}")
    QuestionnaireTemplate findQuestionnaireTemplateByTemplateTypeAndRiskAssociatedEntityAndOrganizationId(Long organizationId, QuestionnaireTemplateType templateType,QuestionnaireTemplateType riskAssociatedEntity);
    ...
    @Query("{organizationId:?0,templateType:?1,defaultAssetTemplate:?2,deleted:false}")
    QuestionnaireTemplate findQuestionnaireTemplateByTemplateTypeAndDefaultAssetTemplateAndOrganizationId(Long organizationId, QuestionnaireTemplateType templateType,boolean defaultAssetTemplate);
    ...
    @Query("{deleted:false,organizationId:?0,assetTypeId:?1,assetSubTypeId:{$in:?2},templateType:?3}")
    QuestionnaireTemplate findQuestionnaireTemplateByTemplateTypeAndAssetTypeAndSubAssetTypeByOrganizationId(Long organizationId, BigInteger assetTypeId, List<BigInteger> subAssetTypeIds,QuestionnaireTemplateType templateType);
    ...
    @Query("{deleted:false,organizationId:?0,assetTypeId:?1,assetSubTypeId:{$exists:false},templateType:?2}")
    QuestionnaireTemplate findQuestionnaireTemplateByTemplateTypeAndAssetTypeAndByOrganizationId(Long organizationId, BigInteger assetTypeId,QuestionnaireTemplateType templateType);
