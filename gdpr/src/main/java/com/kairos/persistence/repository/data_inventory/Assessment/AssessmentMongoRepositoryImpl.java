...
public class AssessmentMongoRepositoryImpl implements CustomAssessmentRepository {
    ...
    public List<AssessmentBasicResponseDTO> findAllAssessmentLaunchedForAssetByAssetIdAndUnitId(Long unitId, BigInteger assetId) {
        ...
        String projectionOperation = "{ '$project':{'_id':1,'name':1,'assessmentScheduledDate':1,'assessmentSchedulingFrequency':1,'endDate':1,'completedDate':1,'comment':1,'assigneeList':1,'approver':1,'createdAt':1,'assessmentStatus':1 , 'risks':{'_id':1,'name':1}}}";
    ...
    public List<AssessmentBasicResponseDTO> findAllAssessmentLaunchedForProcessingActivityByActivityIdAndUnitId(Long unitId, BigInteger processingActivityId) {
        ...
        String projectionOperation = "{ '$project':{'_id':1,'name':1,'endDate':1,'completedDate':1,'comment':1,'assigneeList':1,'approver':1,'createdAt':1,'assessmentStatus':1, 'risks':{'_id':1,'name':1}}}";
