...
public class DataElementController {
    ...
    public ResponseEntity<ResponseDTO<DataElementBasicResponseDTO>> getCountryDataElementById(@PathVariable Long countryId, @PathVariable BigInteger dataElementId) {
    ...
    public ResponseEntity<ResponseDTO<List<DataElementBasicResponseDTO>>> getAllCountryDataElement(@PathVariable Long countryId) {
