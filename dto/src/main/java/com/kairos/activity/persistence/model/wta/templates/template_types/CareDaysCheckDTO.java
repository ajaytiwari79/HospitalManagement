 ...
 */
public class CareDaysCheckDTO extends WTABaseRuleTemplateDTO{
    ...
    public CareDaysCheckDTO() {
        //Default Constructor
    }

    public CareDaysCheckDTO(String name, boolean minimum, boolean disabled, String description, List<AgeRangeDTO> ageRange, List<Long> activities, long validationStartDateMillis, Long numberOfWeeks) {
