...
public class ShiftDayTemplateDTO {
    ...
    private List<ShiftDayTemplateDTO> subShifts;

    public ShiftDayTemplateDTO() {
        //Default Constructor
    }
    ...
    public List<ShiftDayTemplateDTO> getSubShifts() {
        return subShifts;
    }

    public void setSubShifts(List<ShiftDayTemplateDTO> subShifts) {
        this.subShifts = subShifts;
    }
}
