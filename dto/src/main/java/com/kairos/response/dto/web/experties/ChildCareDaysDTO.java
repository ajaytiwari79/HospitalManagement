...
@Valid
public class ChildCareDaysDTO implements Comparable<ChildCareDaysDTO>{
    private int from;
    private int to;
    private int leavesAllowed;

    public ChildCareDaysDTO() {
        //Default Constructor
    }

    public ChildCareDaysDTO(int from, int to, int leavesAllowed) {
        this.from = from;
        this.to = to;
    ...
    @Override
    public int compareTo(ChildCareDaysDTO o) {
