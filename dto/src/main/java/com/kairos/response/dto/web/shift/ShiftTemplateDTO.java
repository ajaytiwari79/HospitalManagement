...
public class ShiftTemplateDTO {
    ...
    public ShiftTemplateDTO(BigInteger id, String name, long bonusTimeBank, long amount, long probability, long accumulatedTimeBankInMinutes, String remarks, @Range(min = 0)
    @NotNull(message = "error.shiftTemplate.activityId.notnull") BigInteger activityId,
                            Long unitId, @Range(min = 0) @NotNull(message = "error.shiftTemplate.staffId.notnull") Long staffId, @Range(min = 0)
