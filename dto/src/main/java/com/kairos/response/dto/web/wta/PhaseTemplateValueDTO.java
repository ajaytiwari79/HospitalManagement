...
public class PhaseTemplateValueDTO {
    private int phaseId;
    ...
    public PhaseTemplateValueDTO() {
        //Default Constructor
    }

    public PhaseTemplateValueDTO(int phaseId, String phaseName, short staffValue, short managementValue, boolean disabled, int optionalFrequency, boolean optional) {
        this.phaseId = phaseId;
