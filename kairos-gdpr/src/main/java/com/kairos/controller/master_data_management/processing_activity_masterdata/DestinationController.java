...
public class DestinationController {
    ...
    @PostMapping("/add")
    public ResponseEntity<Object> createDestination(@PathVariable Long countryId, @PathVariable Long organizationId, @Valid @RequestBody ValidateDTOList<Destination> destinations) {
        if (countryId == null) {
