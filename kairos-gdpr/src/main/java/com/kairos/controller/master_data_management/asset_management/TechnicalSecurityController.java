...
public class TechnicalSecurityController {
    ...
    @PostMapping("/add")
    public ResponseEntity<Object> createTechnicalSecurityMeasure(@PathVariable Long countryId,@PathVariable Long organizationId,@Valid @RequestBody ValidateDTOList<TechnicalSecurityMeasure> securityMeasures) {
       if (countryId == null) {
