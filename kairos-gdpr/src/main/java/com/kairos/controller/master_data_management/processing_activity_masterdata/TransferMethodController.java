...
public class TransferMethodController {
    ...
    @PostMapping("/add")
    public ResponseEntity<Object> createTransferMethod(@PathVariable Long countryId, @PathVariable Long organizationId, @Valid @RequestBody ValidateDTOList<TransferMethod> transferMethods) {
        if (countryId == null) {
