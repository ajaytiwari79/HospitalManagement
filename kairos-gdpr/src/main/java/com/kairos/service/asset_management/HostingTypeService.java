...
import com.kairos.persistance.repository.asset_management.HostingTypeMongoRepository;
...
public class HostingTypeService extends MongoBaseService {
    ...
    public HostingType getHostingTypeById(BigInteger id) {
    ...
    public Boolean deleteHostingTypeById(BigInteger id) {
