...
public enum FilterType {
    ...
    SKILLS("Skills"),REAL_TIME_STATUS("Real Time Status"),
    ...
    ABSENCE_ACTIVITY("Absence Activity"),FUNCTIONS("Functions"),VALIDATED_BY("Validated By"),CALCULATION_TYPE("Calculation type"),CALCULATION_BASED_ON("Calculation Based On"),CALCULATION_UNIT("Calculation Unit"),REASON_CODE("Reason Code");
