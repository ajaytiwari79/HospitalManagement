...
public enum CalculationType {
    ...
    CHILD_CARE_DAYS("Childcare days left"),CARE_DAYS("Vacations days left "),PROTECTED_DAYS_OFF("protected days off"),BREAK_INTERRUPT("Break Interrupt"),ESCALATED_SHIFTS("Escalated Shifts"),
    ESCALATION_RESOLVED_SHIFTS("Escalated Resolved Shifts"),ACTUAL_TIMEBANK("Actual TimeBank"),ABSENCE_REQUEST("Absence Request"),TOTAL_PRESENCE_DAYS("Total Presence Days"),TOTAL_WEEKLY_HOURS("Total weekly Hours");
