...
public enum CalculationType {
    ...
    ESCALATION_RESOLVED_SHIFTS("Escalated Resolved Shifts"),ACTUAL_TIMEBANK("Actual TimeBank"),ABSENCE_REQUEST("Absence Request"),TOTAL_PRESENCE_DAYS("Total Presence Days");
