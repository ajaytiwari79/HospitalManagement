...
public enum CalculationType {
    ...
    PLANNED_HOURS_PAYOUT("Planned Hours of Payout"),COLLECTIVE_TIME_BONUS_PAYOUT("Collective time bonus of payout"),TOTAL_COLLECTIVE_BONUS("Total Collective Bonus"),TOTAL_PLANNED_HOURS("Total Planned Hours"),DELTA_TIMEBANK("Delta Timebank");
