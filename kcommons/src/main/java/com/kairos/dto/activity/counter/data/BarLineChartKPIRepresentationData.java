...
public class BarLineChartKPIRepresentationData extends CommonRepresentationData {
    ...
    public BarLineChartKPIRepresentationData(BigInteger counterId, String title, ChartType chartType, XAxisConfig XAxisConfig, RepresentationUnit unit, List<CommonKpiDataUnit> dataList, KPIAxisData xAxis, KPIAxisData yAxis, KPIAxisData zAxis) {
