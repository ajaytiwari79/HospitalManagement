...
public class EmploymentLinesDTO {
    ...
    public EmploymentLinesDTO() {}

    public EmploymentLinesDTO(LocalDate startDate, LocalDate endDate, Integer workingDaysInWeek, Integer totalWeeklyHours, Integer totalWeeklyMinutes, BigDecimal hourlyCost) {
