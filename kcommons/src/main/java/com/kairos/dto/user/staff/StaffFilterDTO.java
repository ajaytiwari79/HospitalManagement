...
public class StaffFilterDTO {
    ...
    public boolean isValidFilterForShift(){
        ...
        Set<FilterType> filterTypeSet = newHashSet(TIME_TYPE,ACTIVITY_TIMECALCULATION_TYPE,ACTIVITY_STATUS,TIME_SLOT,ABSENCE_ACTIVITY,VALIDATED_BY,PLANNED_TIME_TYPE,REAL_TIME_STATUS,TIME_TYPE,FUNCTIONS,GROUPS,ESCALATION_CAUSED_BY,TIME_BANK_BALANCE,ASSIGN_ACTIVITY,ASSIGN_TIME_TYPE);
