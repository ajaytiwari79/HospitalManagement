...
public class ActivityLineIntervalSwapMove extends AbstractMove<ShiftRequestPhasePlanningSolution> {
    ...
    private ShiftRequestPhase leftToShift;
    private List<ActivityLineInterval> leftExActivityLineIntervals;
    private ShiftRequestPhase leftExToShift;
    private ActivityLineInterval rightActivityLineInterval;
    private ShiftRequestPhase rightToShift;
    private List<ActivityLineInterval> rightExActivityLineIntervals;
    private ShiftRequestPhase rightExToShift;
    private static Logger log= LoggerFactory.getLogger(ActivityLineIntervalSwapMove.class);
    public ActivityLineIntervalSwapMove(ActivityLineInterval leftActivityLineInterval, ShiftRequestPhase leftToShift, List<ActivityLineInterval> leftExActivityLineIntervals,ShiftRequestPhase leftExToShift,
                                        ActivityLineInterval rightActivityLineInterval, ShiftRequestPhase rightToShift, List<ActivityLineInterval> rightExActivityLineIntervals, ShiftRequestPhase rightExToShift) {
