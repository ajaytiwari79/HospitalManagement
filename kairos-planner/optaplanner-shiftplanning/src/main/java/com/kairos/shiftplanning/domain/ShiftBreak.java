...
public class ShiftBreak {
    ...
    public ShiftBreak(){}
    public ShiftBreak(String id, int order, int duration, ShiftRequestPhase shift) {
        this.id = id;
        this.order = order;
        this.duration=duration;
        this.shift=shift;
    ...
    public boolean isBreakValid(ShiftConstrutionPhase shift){
        return startTime ==null || shift.getInterval()==null ||  shift.getInterval().contains(this.getInterval());
    }
