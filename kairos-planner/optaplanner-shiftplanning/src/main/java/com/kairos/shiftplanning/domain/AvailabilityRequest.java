...
public class AvailabilityRequest {
	...
	public AvailabilityRequest(Long id, DateTime startTime, DateTime endTime,EmployeePlanningFact employee) {
    ...
    public AvailabilityRequest(EmployeePlanningFact employee, Interval interval) {
