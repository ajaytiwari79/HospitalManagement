...
public class StaticField {
	...
	public final static String GROUPID = "com.kairos.planning";
	public final static String ARTIFACTID = "task-planning";
	...
	public final static String PLANNING = "api/taskPlanning/planning";
	public final static String INTEGRATION = "api/taskPlanning/integration";
	public final static String TASKPLANNING_XMLPATH = "optaplanner/src/test/resources/com/kairos/planning/configuration/OutdoorTaskPlanning.solver.xml";
	...
	public final static String COM_KAIROS_PLANNING_DOMAIN = "com.kairos.planning.domain.*;";
	...
	public final static String COM_KAIROS_PLANNING_RULES = "com.kairos.planning.rules";
