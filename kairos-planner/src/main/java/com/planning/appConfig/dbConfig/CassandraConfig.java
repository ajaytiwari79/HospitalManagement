package com.planning.appConfig.dbConfig;
...
@Configuration
@EnableCassandraRepositories(basePackages = { "com.planning.repository" })
public class CassandraConfig extends AbstractCassandraConfiguration {
    ...
    public String[] getEntityBasePackages() {
        return new String[] {"com.planning.domain"}; //com.example package contains the bean with @table annotation
    }
}
