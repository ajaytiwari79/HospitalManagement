...
public class ShortestAndAverageDailyRestDTO {
    ...
    public ShortestAndAverageDailyRestDTO(long averageRest, int weight, String level) {
        this.averageRest = averageRest;
        this.weight = weight;
        this.level = level;
    }

    public ShortestAndAverageDailyRestDTO(List<String> balanceType, long intervalLength, String intervalUnit, long validationStartDateMillis, long continuousDayRestHours, long averageRest, String shiftAffiliation) {
        this.balanceType = balanceType;
        this.intervalLength = intervalLength;
        this.intervalUnit = intervalUnit;
        this.validationStartDateMillis = validationStartDateMillis;
    ...
    public ShortestAndAverageDailyRestDTO() {
    }
