...
public class TimeBankCalculationService {
   ...
   /* *//**
     ...
     * @return DailyTimeBankEntry
     */
    public DailyTimeBankEntry calculateDailyTimebank(Interval interval, StaffAdditionalInfoDTO staffAdditionalInfoDTO, List<ShiftWithActivityDTO> shifts) {
            ...
            for (ShiftActivityDTO shiftActivity : shift.getActivities()) {
                ...
                if (interval.overlaps(shiftInterval)) {
                    ...
                    for (CTARuleTemplateDTO ruleTemplate : ctaDto.getCtaRuleTemplates()) {
                        if (validateCTARuleTemplateDTO(ruleTemplate,staffAdditionalInfoDTO.getUserAccessRoleDTO(),ctaDto.getEmploymentType(),shift.getPhaseId())) {
     ...
     * @date 6-10-2018
     */
    private boolean validateCTARuleTemplateDTO(CTARuleTemplateDTO ruleTemplate, UserAccessRoleDTO userAccessRoleDTO, EmploymentType employmentType, BigInteger shiftPhaseId)
    {
        ...
        else if (CollectionUtils.isNotEmpty(ruleTemplate.getEmploymentTypes()) && !ruleTemplate.getEmploymentTypes().contains(employmentType)) return false;
