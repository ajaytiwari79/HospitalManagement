...
public class FlexibleTimeSettingsController {
    ...
    @PutMapping(value = UNIT_FLEXI_TIME_SETTINGS)
    public ResponseEntity<Map<String,Object>> saveFlexibleTimeSettingsForUnit(@PathVariable Long unitId, @RequestBody FlexibleTimeSettingsDTO flexibleTimeSettings){
        return ResponseHandler.generateResponse(HttpStatus.OK,true,flexibleTimeSettingsService.saveFlexibleTimeSettingsForUnit(unitId,flexibleTimeSettings));
    }

    @GetMapping(value = UNIT_FLEXI_TIME_SETTINGS)
    public ResponseEntity<Map<String,Object>> getFlexibleTimeSettingsForUnit(@PathVariable Long unitId){
        return ResponseHandler.generateResponse(HttpStatus.OK,true,flexibleTimeSettingsService.getFlexibleTimeSettingsForUnit(unitId));
    }
