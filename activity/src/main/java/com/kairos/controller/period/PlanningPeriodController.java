...
public class PlanningPeriodController {
    ...
    //@PreAuthorize("@customPermissionEvaluator.isAuthorized()")
    public ResponseEntity<Map<String, Object>> updatePlanningPeriodPhaseToNext(@PathVariable BigInteger periodId, @PathVariable Long unitId , @RequestParam(required = false, value = "employmentTypeIds") List<Long> employmentTypeIds) {
