...
public class ShiftController {
    ...
    public ResponseEntity<Map<String, Object>> sendShiftInTimeAndAttendancePhase(@PathVariable Long unitId,@RequestParam(value = "staffId",required = false) Long staffId, @RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") Date startDate, @RequestParam(value = "staffId",required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") Date endDate) {
