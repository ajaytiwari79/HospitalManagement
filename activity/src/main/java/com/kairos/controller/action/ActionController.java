...
public class ActionController {
    ...
    ResponseEntity<Map<String, Object>> removeAvailabilityUnavailabilityBeforeAfterShift(@PathVariable Long staffId,@RequestParam boolean isAvailability,@RequestParam boolean isBefore, @RequestParam boolean isRemoveOneNearest, @RequestParam("shift_date") @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date ShiftDate){
        return ResponseHandler.generateResponse(HttpStatus.OK, true, actionService.removeAvailabilityUnavailabilityBeforeAfterShift(staffId, isAvailability, isBefore, isRemoveOneNearest, ShiftDate));
    }
