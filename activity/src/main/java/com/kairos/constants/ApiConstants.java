...
public final class ApiConstants {
    ...
    public static final String REMOVE_FUNCTIONS_BY_UNIT_POSITION_ID = "/employment/{employmentId}/remove_functions";
    public static final String RESTORE_FUNCTIONS_BY_UNIT_POSITION_ID = "/employment/{employmentId}/restore_functions";
    public static final String APPLY_FUNCTION="/employment/{employmentId}/applyFunction";
    public static final String UNIT_POSITION_UNIT_POSITION_ID_REMOVE_FUNCTION_ON_DELETE_SHIFT = "/employment/{employmentId}/remove_function_on_delete_shift";
    ...
    public static final String UNIT_POSITIONS_BY_EXPERTISE_ID = "/expertise/{expertiseId}/employments";
    ...
    public static final String STAFF_ID_EXPERTISE_ID_UNIT_POSITION_ID = "/staff/{staffId}/expertise/{expertiseId}/employmentId";
    ...
    public static final String GET_UNIT_BY_UNIT_POSITION= GET_EMPLOYMENT+"/get_unit";
