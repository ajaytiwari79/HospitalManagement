...
import com.kairos.persistence.model.open_shift.*;
import com.kairos.persistence.repository.open_shift.*;
...
public class OpenShiftService extends MongoBaseService {
    ...
    private boolean assignShiftToStaff(OpenShift openShift, Long unitId, List<Long> staffIds, Order order) {
        ...
        employmentDetails.forEach(employmentDetail -> {
            ...
            shiftService.createShift(unitId, shiftDTO, "Organization",null);
