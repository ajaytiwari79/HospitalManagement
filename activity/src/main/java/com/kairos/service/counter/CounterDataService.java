...
public class CounterDataService {
    ...
    private KPI prepareTaskUnplannedKPI(long tasksUnplanned, long totalTasks){
        ...
        KPI kpi = new KPI(CounterType.TASK_UNPLANNED.getName(), baseChart, CounterSize.SIZE_1X1, CounterType.TASK_UNPLANNED, null);
    ...
    private KPI prepareTaskUnplannedHours(double unplannedMinutes, double plannedMinutes){
        ...
        KPI kpi = new KPI(CounterType.TASK_UNPLANNED_HOURS.getName(), baseChart, CounterSize.SIZE_1X1, CounterType.TASK_UNPLANNED_HOURS, null);
    ...
    private KPI prepareTaskTimeVsWorkingTime(double workingTime, double totalTaskTime){
        ...
        KPI kpi = new KPI(CounterType.TOTAL_TASK_TIME_PERCENT.getName(), baseChart, CounterSize.SIZE_1X1, CounterType.TOTAL_TASK_TIME_PERCENT, null);
    ...
    private KPI prepareRoadTimePercentKPI(double roadTimePercent){
        ...
        KPI kpi = new KPI(CounterType.ROAD_TIME_PERCENT.getName(), baseChart, CounterSize.SIZE_1X1, CounterType.ROAD_TIME_PERCENT, null);
    ...
    private KPI prepareCompletedTaskWithinTimeWindow(long completedTasksCount){
        ...
        KPI kpi = new KPI(CounterType.TASKS_COMPLETED_WITHIN_TIME.getName(), baseChart, CounterSize.SIZE_1X1, CounterType.TASKS_COMPLETED_WITHIN_TIME, null);
    ...
    private KPI preparePercentOfBreaksIn11and13KPI(double validBreakPercentage){
        ...
        KPI kpi = new KPI(CounterType.VALID_BREAK_PERCENT.getName(), baseChart, CounterSize.SIZE_1X1, CounterType.VALID_BREAK_PERCENT, null);
    ...
    private KPI prepareFlexiTimePercentKPI(double flexiTimePercent){
        ...
        KPI kpi = new KPI(CounterType.FLEXI_TIME_PERCENT.getName(), baseChart, CounterSize.SIZE_1X1, CounterType.FLEXI_TIME_PERCENT, null);
    ...
    private KPI prepareFlexiTimeTaskPercent(double flexiTimeTaskPercent){
        ...
        KPI kpi = new KPI(CounterType.FLEXI_TIME_TASK_PERCENT.getName(), baseChart, CounterSize.SIZE_1X1, CounterType.FLEXI_TIME_PERCENT, null);
    ...
    private KPI prepareTotalKMDrivenByStaff(Map<String, Double> staffAndKMDetails){
        ...
        KPI kpi = new KPI(CounterType.TOTAL_KM_DRIVEN_PER_STAFF.getName(), baseChart, CounterSize.SIZE_1X1, CounterType.TOTAL_KM_DRIVEN_PER_STAFF, null);
        kpi.setId(new BigInteger("3"));
        return kpi;
    }
    ...
    public KPI prepareTaskEfficiencyKPI(double efficiency){
        ...
        KPI kpi = new KPI(CounterType.TASK_EFFICIENCY.getName(), baseChart, CounterSize.SIZE_1X1, CounterType.TASK_EFFICIENCY, null);
        kpi.setId(new BigInteger("9"));
        return kpi;
    }
