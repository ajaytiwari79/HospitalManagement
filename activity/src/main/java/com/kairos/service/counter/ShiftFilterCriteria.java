...
public class ShiftFilterCriteria {
    ...
    private ShiftFilterCriteria(boolean useActivity){
    ...
    public ShiftFilterCriteria setTimeInterval(List<Date> timeInterval){
        matchCriteria = matchCriteria.and("startDate").gt(timeInterval.get(0)).and("startDate").lt(timeInterval.get(1));
        return this;
    }

    public ShiftFilterCriteria setActivityIds(List<BigInteger> activityIds){
    ...
    public ShiftFilterCriteria setUnitId(List<Long> unitIds) {
    ...
    public ShiftFilterCriteria setStaffIds(List<Long> staffIds) {
