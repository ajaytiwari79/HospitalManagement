...
public class CounterDistService extends MongoBaseService {
    ...
    public List<TabKPIDTO> updateInitialTabKPIDataConf(TabKPIDTO tabKPIDTO,Long unitId,ConfLevel level){
    ...
    public void removeAccessGroupKPIEntries(AccessGroupMappingDTO accessGroupMappingDTO,Long refId,ConfLevel level) {
       ...
       //     counterRepository.removeDashboardKPIEntry(staffIds,accessGroupKPIEntry.getKpiId(),ConfLevel.STAFF);
