...
public class AbsencePlanningService {
    ...
    public Map<Long, Map<ShiftStatus, Long>> getAbsencePlanningActivityStatusForStaff(List<Shift> shifts, List<Long> staffIds) {

        Map<ShiftStatus, Long> shiftActivityStatus;
        Map<Long, Map<ShiftStatus, Long>> staffActivityStatusMap = new HashMap<>();
    ...
    public Map<ShiftStatus, Long> getAbsencePlanningActivityStatusForPerInterval(List<Long> staffIds, Map<DateTimeInterval, List<Shift>> dateTimeIntervalListMap, List<DateTimeInterval> dateTimeIntervals, DurationType frequencyType) {
       Map<ShiftStatus, Long> shiftActivityStatus;
       Map<Long,Map<ShiftStatus, Long>> staffActivityStatusMap = new HashMap<>();
