...
public class ShiftValidatorService {
    ...
    public ShiftWithViolatedInfoDTO validateShiftWithActivity(Phase phase, WTAQueryResultDTO wtaQueryResultDTO, ShiftWithActivityDTO shift, StaffAdditionalInfoDTO staffAdditionalInfoDTO, Shift oldShift, Map<BigInteger, ActivityWrapper> activityWrapperMap, boolean byUpdate, boolean byTandAPhase) {
        ...
        validateGracePeriod(shift.getStartDate(),UserContext.getUserDetails().isStaff(),shift.getUnitId(),phase);
        ...
        TimeAttendanceGracePeriod timeAttendanceGracePeriod=timeAttendanceGracePeriodRepository.findByUnitId(shift.getUnitId());
        ...
        Specification<ShiftWithActivityDTO> gracePeriodSpecification = new GracePeriodSpecification(timeAttendanceGracePeriod);
        Specification<ShiftWithActivityDTO> activitySpecification = activityExpertiseSpecification.and(activitySkillSpec).and(wtaRulesSpecification).and(tagSpecification).and(staffActivitySpecification).and(gracePeriodSpecification);
    ...
    public void validateStaffingLevel(Phase phase, Shift shift, Map<BigInteger, ActivityWrapper> activityWrapperMap, boolean checkOverStaffing, ShiftActivity shiftActivity, RuleTemplateSpecificInfo ruleTemplateSpecificInfo,StaffingLevelHelper staffingLevelHelper) {
