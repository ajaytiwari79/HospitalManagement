...
public class SolverConfigService extends MongoBaseService {
    ...
    public void createDefaultConfig(Long unitId) {
        ...
        constraints.add(new Constraint("Must Be Planned", "Task should be done in time slots window- Morning and afternoon", ConstraintCategory.DURATION_CONSTRAINTS, PlanningType.VRPPLANNING, unitId,false,true,true));
