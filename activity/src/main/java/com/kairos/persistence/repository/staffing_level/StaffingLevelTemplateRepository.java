...
public interface StaffingLevelTemplateRepository extends MongoBaseRepository<StaffingLevelTemplate,BigInteger>,CustomStaffingLevelTemplateRepository {
    ...
    List<StaffingLevelTemplateDTO> findByUnitIdAndValidityStartDateGreaterThanEqualAndValidityEndDateLessThanEqualAndDayTypeInAndValidDaysIn(Long unitID, Date selectedDateParam1, Date selectedDateParam2,List<Long> dayTypeId, List<String> days);
