...
public class ShiftJson {
    ...
    public static String getShiftDTOJSON(){
        return "{\n" +
                "   \"id\":2636,\n" +
    ...
    public static String getActivityDetailsJson(){
        return "{\n" +
                "   \"activity\":{\n" +
                "      \"id\":823,\n" +
                "      \"deleted\":false,\n" +
    ...
    public static String getListOfShiftViolationRules(){
        return "[\n" +
                "   {\n" +
                "      \"id\":2328,\n" +
                "      \"deleted\":false,\n" +
    ...
    public static String getOverLappedShift(){
        return "[\n" +
                "   {\n" +
                "      \"id\":2636,\n" +
                "      \"deleted\":false,\n" +
