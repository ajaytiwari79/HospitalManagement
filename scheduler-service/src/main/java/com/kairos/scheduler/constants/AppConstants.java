...
public class AppConstants {
    ...
    public final static Set<JobSubType> activitySubTypes = Stream.of(PRIORITYGROUP_FILTER, FLIP_PHASE, SHIFT_REMINDER, UPDATE_USER_ABSENCE,ATTENDANCE_SETTING,CREATE_PAYROLL_PERIOD).collect(Collectors.toSet());
