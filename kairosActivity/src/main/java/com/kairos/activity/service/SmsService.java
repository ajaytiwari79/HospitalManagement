...
public class SmsService {
    ...
    public boolean sendSms(String recipient, String message) {
        ...
        try {
            ...
            params.add(new BasicNameValuePair(AppConstants.BODY, message));
            params.add(new BasicNameValuePair(AppConstants.TO, recipient));
            params.add(new BasicNameValuePair(AppConstants.FROM, envConfig.getGetTwillioNumber()));
