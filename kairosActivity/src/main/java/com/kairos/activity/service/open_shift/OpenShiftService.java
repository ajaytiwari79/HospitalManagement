...
import static com.kairos.response.dto.web.open_shift.ShiftAssignmentCriteria.FIRST_PICK;
...
public class OpenShiftService extends MongoBaseService {
    ...
    public OpenShiftResponseDTO pickOpenShiftByStaff(long unitId, BigInteger openShiftId, long staffId) {
        ...
        Order shiftAssignmentCriteria=orderMongoRepository.findShiftAssignmentCriteria(unitId,openShift.getOrderId());




        if (shiftAssignmentCriteria.equals(FIRST_PICK)) {
