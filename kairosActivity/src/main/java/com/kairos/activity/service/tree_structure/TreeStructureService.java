package com.kairos.activity.service.tree_structure;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.kairos.activity.persistence.model.common.QueryResult;
...
public class TreeStructureService {
    ...
    public QueryResult getTreeStructure(List<QueryResult> queryResults) {
      ...
      /*  QueryResult queryResult = new QueryResult(firstRecord.getName(), firstRecord.getId(), firstRecord.getCompositeActivities());
