package com.kairos.activity.service.solver_config;

import com.kairos.activity.persistence.model.solver_config.Constraint;
import com.kairos.activity.persistence.model.solver_config.ConstraintValue;
import com.kairos.activity.persistence.model.solver_config.SolverConfig;
import com.kairos.activity.persistence.repository.solver_config.ConstraintRepository;
...
public class SolverConfigService extends MongoBaseService{
    ...
    public SolverConfigDTO updateSolverConfig(Long unitId,SolverConfigDTO solverConfigDTO){
    ...
    public void createDefaultConfig(Long unitId){
       ...
       /* constraints.add(new Constraint("","Staff should perform all task for a citizen in one go without any break.", ConstraintCategory.BREAK_CONSTRAINTS,PlanningType.VRPPLANNING,unitId));*/
        ...
        SolverConfig solverConfig = new SolverConfig(unitId,"Default Configuration",false, PlanningType.VRPPLANNING,null,300,constraintValues,true);
        save(solverConfig);
    }
