package com.kairos.activity.service.planner;
...
import com.kairos.activity.custom_exception.DataNotModifiedException;
import com.kairos.activity.enums.CitizenHealthStatus;
import com.kairos.activity.persistence.enums.task_type.DelayPenalty;
import com.kairos.activity.persistence.enums.task_type.TaskTypeEnum;
import com.kairos.activity.persistence.model.CustomTimeScale;
...
import com.kairos.activity.persistence.model.task.SkillExpertise;
...
import com.kairos.activity.persistence.model.task.*;
import com.kairos.activity.persistence.model.task_demand.TaskDemand;
import com.kairos.activity.persistence.model.task_demand.TaskDemandVisit;
import com.kairos.activity.persistence.model.task_type.TaskType;
import com.kairos.activity.persistence.model.task_type.TaskTypeSkill;
import com.kairos.activity.persistence.model.task_type.TaskTypeSlaConfig;
import com.kairos.activity.persistence.query_result.TaskCountWithAssignedUnit;
import com.kairos.activity.persistence.repository.CustomTimeScaleRepository;
import com.kairos.activity.persistence.repository.client_exception.ClientExceptionMongoRepository;
import com.kairos.activity.persistence.repository.client_exception.ClientExceptionTypeMongoRepository;
import com.kairos.activity.persistence.repository.common.CustomAggregationOperation;
import com.kairos.activity.persistence.repository.repository_impl.TaskMongoRepositoryImpl;
import com.kairos.activity.persistence.repository.task_type.TaskDemandMongoRepository;
...
import com.kairos.activity.persistence.repository.task_type.TaskTypeSlaConfigMongoRepository;
...
import static com.kairos.activity.constants.AppConstants.FORWARD_SLASH;
import static com.kairos.activity.constants.AppConstants.MERGED_TASK_NAME;
import static com.kairos.activity.persistence.model.constants.ClientExceptionConstant.SICK;
import static com.kairos.activity.persistence.model.constants.TaskConstants.*;
import static com.kairos.activity.persistence.model.task.TaskStatus.CANCELLED;

import static com.kairos.activity.util.DateUtils.ISO_FORMAT;
...
public class PlannerService extends MongoBaseService {
    ...
    public Map<String, Object> getCitizenPlanning(long unitId, long citizenId, boolean isActualPlanningScreen, String startDate) throws ParseException {
        ...
        //anil m2
        Map<String, Object> clientAddressInfo=clientRestClient.getClientAddressInfo(citizenId);
...
*/
    ...
    private List<Task> getTasksFromDemandVisits(TaskDemandVisit taskDemandVisit, TaskDemand taskDemand, boolean isWeekend,
        ...
        TaskDemandVisitWrapper taskDemandInfo=clientRestClient.
    ...
    private  Map<String, Object> getOrganizationClientsWithPlanning(Long organizationId) {
        ...
        OrganizationClientWrapper organizationClientWrapper= clientRestClient.getOrganizationClients(organizationId);
    ...
    private  Map<String, Object> getClintsWithPlanningByClintIds(List<Long> citizenIds, Long unitId) {
        Map<String, Object> response = new HashMap<>();
        List<Object> clientList = new ArrayList<>();
        OrganizationClientWrapper organizationClientWrapper=clientRestClient.
                getClientsByIds(unitId,citizenIds);
