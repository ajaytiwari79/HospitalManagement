package com.kairos.activity.persistence.model.client_exception;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.kairos.activity.response.dto.AddressDTO;
...
public class ClientExceptionDTO {
    ...
    private ClientException.TaskOperation taskStatus;
    ...
    public ClientException.TaskOperation getTaskStatus() {
        return taskStatus;
    }

    public void setTaskStatus(ClientException.TaskOperation taskStatus) {
