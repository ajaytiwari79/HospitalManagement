...
public class FeatureRule {
    ...
    public FeatureRule(boolean showCost, boolean allowInstantPayment, boolean allowTimeBank, boolean chatWithPlanner, boolean allowCounterProposal, boolean allowComments) {
