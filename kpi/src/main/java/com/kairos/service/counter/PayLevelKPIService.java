...
public class PayLevelKPIService implements KPIService{
    ...
    public EmploymentLinesDTO getCurrentlyActiveLine(LocalDate selectedDate,List<EmploymentLinesDTO> employmentLines) {
        selectedDate = selectedDate == null ? DateUtils.getCurrentLocalDate() : selectedDate;
        EmploymentLinesDTO currentEmploymentLine = null;
        for (EmploymentLinesDTO employmentLinesDTO : employmentLines) {
            if (DateUtils.startDateIsEqualsOrBeforeEndDate(employmentLinesDTO.getStartDate(),selectedDate ) &&
                    (employmentLinesDTO.getEndDate() == null || DateUtils.startDateIsEqualsOrBeforeEndDate(selectedDate, employmentLinesDTO.getEndDate()))) {
