...
public class ShiftPlanningInitializationController {
    ...
    ResponseEntity<Map<String, Object>> getWTA() {
        ...
        return ResponseHandler.generateResponseWithData(" Data fetched sucessFully", HttpStatus.OK, activityMongoRepository.getWTARuleTemplateByUnitPositionIds(unitPositionIds));
    }

    @RequestMapping("/getShifts")
    ResponseEntity<Map<String, Object>> getShifts() {
        Long[] unitPositionIds = {35682L,35681L};
        return ResponseHandler.generateResponseWithData(" Data fetched sucessFully", HttpStatus.OK, activityMongoRepository.getAllShiftsByUnitPositionIds(unitPositionIds, new Date(1530383400000l), new Date(1532975400000l)));
    }*/
}
