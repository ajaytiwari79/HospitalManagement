...
public class DefaultCountryConstraintService {
    ...
    public static List<CountryConstraint> createDefaultCountryConstraints(Long countryId,BigInteger planningProblemId) {
        ...
        countryConstraintList.add(new CountryConstraint(null, VETO_PER_PERIOD.toString(), commonDescription+"VETO_AND_STOP_BRICKS", ConstraintType.WTA,VETO_PER_PERIOD, ConstraintLevel.SOFT, penaltySoft, PLANNING_PROBLEM_ID, null, COUNTRY_ID, ORGANIZATION_SERVICE_ID, ORGANIZATION_SUB_SERVICE_ID));
