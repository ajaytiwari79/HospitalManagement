...
public class ShiftConstrutionPhasePlanningSolverTest {
    ...
    public SolverConfigDTO getSolverConfigDTO(){
        ...
        constraintDTOS.add(new ConstraintDTO("If this activity is used on a Tuesday", "If this activity is used on a Tuesday",  ConstraintType.ACTIVITY, MAXIMUM_ALLOCATIONS_PER_SHIFT_FOR_THIS_ACTIVITY_PER_STAFF, ConstraintLevel.SOFT, 4,5l));
