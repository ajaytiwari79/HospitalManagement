...
public class PlannedTimeTypeUtils {
    ...
    public static void addPlannedTimeInShift(Shift shift) {
        Set<BigInteger> plannedTimeTypeIds = new HashSet<>();
        for (ShiftActivity shiftActivity : shift.getShiftActivities()) {
            BigInteger plannedTimeId = getPlannedTimeIdByTimeType(shift.getStaff().getUnit(), shiftActivity.getActivity());
