...
public class BreakUtils {
    ...
    public static void updateBreakInShift(Shift shift) {
        BreakSettings breakSettings = shift.getStaff().getBreakSettings();
        ...
        if (isNotNull(breakSettings)) {
            ...
            if (isNotNull(breakSettings) && shift.getMinutes() >= breakSettings.getShiftDurationInMinute()) {
                if (shift.getStaff().getWtaRuleTemplateMap().get(shift.getStartDate()).containsKey(ConstraintSubType.WTA_FOR_BREAKS_IN_SHIFT)) {
                    BreakWTATemplate breakWTATemplate = (BreakWTATemplate)shift.getStaff().getWtaRuleTemplateMap().get(shift.getStartDate()).get(ConstraintSubType.WTA_FOR_BREAKS_IN_SHIFT);
                    BreakAvailabilitySettings breakAvailabilitySettings = findCurrentBreakAvailability(shift.getStart(), shift.getStaff().getUnit().getTimeSlotMap(), breakWTATemplate);
    ...
    private static DateTimeInterval getBreakInterval(Shift shift, BreakAvailabilitySettings breakAvailabilitySettings, BreakSettings breakSettings) {
    ...
    private static DateTimeInterval getDateTimeInterval(Shift shift, BreakSettings breakSettings, ZonedDateTime endDate, ZonedDateTime startDate) {
    ...
    private static ShiftActivity getBreakByShiftActivity(Shift shift, BreakSettings breakSetting, boolean placeBreakAnyWhereInShift, ShiftActivity breakActivity, ZonedDateTime placeBreakAfterThisDate) {
