...
public class UserIntegration {
    ...
    public List<StaffDTO> getStaffData(List<Long> staffIds) throws IOException {
        return publishRequest(staffIds,"",HttpMethod.GET,new HashMap<>());
    }

    private <T> List<StaffDTO> publishRequest(T entity, String url, com.amazonaws.HttpMethod httpMethod, Map<String,T> queryParam) throws IOException {
