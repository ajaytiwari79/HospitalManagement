...
public class  ActivityLineIntervalChangeMoveIterator<T>
    ...
    public ActivityLineIntervalChangeMove next() {
        ...
        ActivityLineIntervalChangeMove changeMove = new ActivityLineIntervalChangeMove(activityLineIntervalWrapper.getActivityLineInterval(),activityLineIntervalWrapper.getShiftRequestPhase(),exIntervals,null);
        return changeMove;
    }
}
/*public class  ActivityLineIntervalChangeMoveIterator<T>
    ...
    public ActivityLineIntervalIteratorMove next() {
        ...
        ActivityLineIntervalIteratorMove changeMove = new ActivityLineIntervalIteratorMove(activityLineIntervalWrapper.getActivityLineInterval(),activityLineIntervalWrapper.getShiftRequestPhase());
        return changeMove;
    }
}*/
